...
//				   new Vector(0,1,0),
//				   new Vector(0,0,1)));
		Material material = new Material(20, 0.55, 0.1, 0.4,0.41);
		...
		scene.addLight(new PointLight(new Color(130, 100, 130), new Point3D(120, 100, -300), 0, 0.00001, 0.000005));
		scene.addLight(new PointLight(new Color(110, 130, 30), new Point3D(180, 150, -50), 0, 0.00001, 0.000005));
    //    scene.addLight(new PointLight(new Color(150, 30, 130), new Point3D(180, -250, -50), 0, 0.00001, 0.000005));
