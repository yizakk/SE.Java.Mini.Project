...
//	    scene.boxing = true;
	    ...
	    scene.addLight(new PointLight(new MyColor(200,200,200), new Point3D(-30,50,60), 1, 0.00005, 0.000003));
	    scene.addLight(new PointLight(new MyColor(00,00,200), new Point3D(80,80,120), 1, 0.00005, 0.000003));
	    scene.addLight(new SpotLight(new MyColor(200,00,000), new Point3D(30,0,-60), new Vector(2,0,1), 1, 0.00005, 0.00003));
	    
	    scene.addLight(new DirectionalLight(new MyColor(10, 100, 10), new Vector(-0.5,0,0)));
	    ...
	    for (double x = -50; x<=50; x+=5)
	    	for (double y = -(50-Math.abs(x)); y<=50-Math.abs(x); y+=5) {
	    		...
	    		s = new Sphere(5, new Point3D(x + 60, y, z),new MyColor((int)Math.abs(x+y+z)%25,
	    ...
	    s = new Sphere(70, new Point3D(80, 0,120),new MyColor(0,0,0));
	    s.setMaterial(new Material(0.05,1,1,0,15));
	    scene.addGeometry(s);
	    
	    s = new Sphere(30, new Point3D(60,0,0),new MyColor(75,0,25));
	    s.setMaterial(new Material(0.2,1,1,0,15));
	    scene.addGeometry(s);
	    
	    s = new Sphere(800, new Point3D(60,-900,0),new MyColor(0,0,0));
	    ...
	    Plane p = new Plane(new Point3D(250, -200, -150),
				  ...
				  new Point3D(250, -200, 200),new MyColor(15,15,15), 
...
//	    scene.addGeometry(p);
	    ...
	    Triangle t =new Triangle(new Point3D(-5000, -200, -70),
	    						 ...
	    						 new Point3D(150, -200, -70),
	    						 new MyColor(7,7,7), new Material(0.1,1,0.5,0.0,99));
	    scene.addGeometry(t);
...
//	  @Test
	  public void bigImageTestOnlyBalls() throws Exception {    
		 ...
		 // scene.addGeometry(s);
		  ...
		  scene.setAmbientLight(new AmbientLight(new MyColor(0,0,0), 0));
