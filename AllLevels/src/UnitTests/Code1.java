...
//	**************************** Background  **********************************   	
     	...
     	q1.setEmmission(new MyColor(20,20,20));
     	q1.setShininess(20);
     	q1.setKr(0.1);
     	q1.setKt(0.6);
...
//**************************** Spheres  ********************************** //
     	...
     	s1.setEmmission(new MyColor (100,120,180));
     	s1.setShininess(20);
     	s1.setKr(1);
     	s1.setKt(0.1);
     	...
     	s4.setEmmission(new MyColor (100,120,180));
     	s4.setShininess(20);
     	s4.setKr(1);
     	s4.setKt(0.1);
     	...
     	s41.setEmmission(new MyColor (100,120,180));
     	s41.setShininess(20);
     	s41.setKr(1);
     	s41.setKt(0.1);
		...
		blueBig.setEmmission(new MyColor(0, 0, 100));
        blueBig.setKt(1);
		
        // Inner little sphere 
		Sphere purpleLittle = new Sphere(50, new Point3D(-70.0, -70.0, -550));
		purpleLittle.setShininess(10);
		purpleLittle.setEmmission(new MyColor(100, 20, 20));
...
// Adding the light at the left down side of the picture
		LightSource spotLeftLeft = new SpotLight(new MyColor(255, 100, 100), 
...
//  left down side of the picture
		LightSource spotLeftDownCorner = new SpotLight(new MyColor(255, 0, 00), 
													   new Point3D(-1500, -1500, -700), 
													   new Vector(2 , 2, 1.5), 0.1, 
													   0.00001, 0.000005);
		
//  right down side of the picture
		LightSource spotRightDown = new SpotLight(new MyColor(50, 80, 100), 
												  new Point3D(1500, -1500, -700), 
												  new Vector(-1, 1.5, 1.5), 0.1, 
												  0.00001, 0.000005);

	//  right down side of the picture
		LightSource spotMidCenter = new SpotLight(new MyColor(50, 80, 100), 
												  new Point3D(-100, 500, -700), 
												  new Vector(1, -1.5, 1.5), 0.1, 
												  0.00001, 0.000005);
// down Point Light	
		LightSource pointLeftCenter = new PointLight(new MyColor(255, 100, 100),
													 new Point3D(-1000, 00,-700), 
													 0, 0.00001, 0.000005);

// down Point Light	
		LightSource pointLeftUP = new PointLight(new MyColor(255, 0, 00),
													 new Point3D(-1500, 1500,-1500), 
													 0, 0.00001, 0.000005);
		
		LightSource dir = new DirectionalLight(new MyColor(255,0,120), new Vector(1,1,1));
...
//************************************* Triangles  ********************************** //   		
		...
		mirror1.setEmmission(new MyColor(20, 20, 20));
		mirror1.setKr(1);
		mirror1.setKt(0.5);
		...
		Triangle mirror2 = new Triangle(new Point3D(  150, 150, -100),
										  ...
										  new Point3D(  200,  200, -375));
		mirror2.setEmmission(new MyColor(20, 20, 20));
		mirror2.setKr(1);
		mirror2.setKt(0.5);
		...
		mirror3.setEmmission(new MyColor(60, 60, 60));
		mirror3.setKr(1);
		mirror3.setKt(0);
		...
		Triangle baseTriangle = new Triangle(new Point3D(  1500, -1500, -1500),
										  new Point3D( -1500,  1500, -1500),
										  new Point3D( -1500, -1500, -1500));
		baseTriangle.setEmmission(new MyColor(60, 60, 60));
